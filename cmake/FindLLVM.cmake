# Detect LLVM and set various variable to link against the different component
# of LLVM
#
# NOTE: This is a modified version of the module originally found in the OpenGTL
# project at www.opengtl.org
#
# LLVM_BIN_DIR : directory with LLVM binaries LLVM_LIB_DIR : directory with LLVM
# library LLVM_INCLUDE_DIR : directory with LLVM include
#
# LLVM_COMPILE_FLAGS : compile flags needed to build a program using LLVM
# headers LLVM_LDFLAGS : ldflags needed to link LLVM_LIBS_CORE : ldflags needed
# to link against a LLVM core library LLVM_LIBS_JIT : ldflags needed to link
# against a LLVM JIT LLVM_LIBS_JIT_OBJECTS : objects you need to add to your
# source when using LLVM JIT
...
if(LLVM_INCLUDE_DIR)
  ...
  # -lLLVMSystem" "" LLVM_LIBS_JIT ${LLVM_LIBS_JIT_RAW}) MESSAGE(STATUS "LLVM
  # JIT libs: " ${LLVM_LIBS_JIT}) MESSAGE(STATUS "LLVM JIT objs: "
